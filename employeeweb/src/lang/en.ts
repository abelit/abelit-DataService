export default {
  route: {
    ...
    guide: 'Guide',
    permission: 'Face Record Management',
    pagePermission: 'Attendance Record',
    rolePermission: 'Create Deparment',
    directivePermission: 'Add Device',
    staffPermission: 'Add Staff',
