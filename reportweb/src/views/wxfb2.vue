      ...
      <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        <b-card style class="mb-2">
          ...
          <b-form-group label="*是否提供会员福利">
            <b-form-radio v-model="form.mem_check" name="some-radios" value="1"
              >是</b-form-radio
            >
            <b-form-radio v-model="form.mem_check" name="some-radios" value="0"
              >否</b-form-radio
            >
          </b-form-group>
          <div>
            ...
            >
              ...
              <b-form-textarea
                ...
                v-model="form.mem_other"
              ></b-form-textarea>
            </b-form-group>
            <label>备注</label>
            <ul>
              <li>
                租户承诺此次活动真实可信，完成此确认函双边签署后，租户应及时宣导每一位店员完全知悉并认真执行此活动内容，不得中途修改内容或终止活动。
              </li>
              <li>
                折扣活动由租户直接实现优惠，不额外产生任何费用，不与其他优惠同享。
              </li>
              <li>
                此确认函租户签字盖章后，经由宏立城商业管理有限公司品牌市场中心会员管理市场部签章确认生效。
              </li>
            </ul>
          </div>
        </b-card>
        ...
        <b-form-group id="input-group-7" label="电子邮箱" label-for="input-7">
          <b-form-input
            id="input-7"
            v-model="form.sign_email"
            type="email"
          ></b-form-input>
        </b-form-group>
        <b-button block type="submit" variant="outline-primary" class="mb-5"
          >提交</b-button
        >
